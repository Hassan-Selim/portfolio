...
const I18N = {
  ar: {
    ...
    "comments.title": "أراء العملاء",
    "comments.desc": "بعض من تعليقات العملاء",
    "contact.title": "تواصل",
  ...
  en: {
    ...
    "comments.desc": "Some of Clients Comments",
    ...
    error404p:
      "doesn't look like you took the right path. Don't worry, we'll get you back to the right place.",
...
async function openProject(postId) {
  ...
  try {
    ...
    let optimizedContent = data.content.replace(/\/s\d+\//g, "/w600-rw/");
    ...
    container.innerHTML =
      '<p style="color: #ff4757; text-align: center; margin-top: 20px;">حدث خطأ أثناء تحميل المشروع.</p>';
  }
}
function closeModal() {
  modal.classList.remove("active");
